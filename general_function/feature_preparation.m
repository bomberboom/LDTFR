% calculate SPD and data preparation
% input: data path of train data, train label, test data, test label
% output: train and test data in the form of SPD and coresponding label

function [covD_Struct]=feature_preparation(path_data)
...
trn_y=double(train_label)+1;%  Make labels start at 1 rather than 0
